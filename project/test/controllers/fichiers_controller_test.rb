...
class FichiersControllerTest < ActionController::TestCase
  ...
  test "should create fichier" do
    assert_difference('Fichier.count') do
      post :create, fichier: { filepath: @fichier.filepath, name: @fichier.name, record_date: @fichier.record_date }
    end
  ...
  test "should update fichier" do
    patch :update, id: @fichier, fichier: { filepath: @fichier.filepath, name: @fichier.name, record_date: @fichier.record_date }
    assert_redirected_to fichier_path(assigns(:fichier))
  end
